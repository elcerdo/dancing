...
void reshape(int w, int h)
{
	...
	case 0:
		...
		break;
	case 1:
		if (w <= h) glFrustum(-10.0, 10.0, -10.0*(GLfloat)h/(GLfloat)w, 10.0*(GLfloat)h/(GLfloat)w, 5.0, 15.0);
		else glFrustum(-10.0*(GLfloat)w/(GLfloat)h, 10.0*(GLfloat)w/(GLfloat)h, -10.0, 10.0, 5.0, 15.0);
		break;
	default:
		printf("unknown mode\n");
		break;
